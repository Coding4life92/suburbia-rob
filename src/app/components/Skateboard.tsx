...
export function Skateboard({
    ...
    const metalNornal = useTexture('/skateboard/metal-normal.avif');
    metalNornal.wrapS = THREE.RepeatWrapping;
    metalNornal.wrapT = THREE.RepeatWrapping;
    metalNornal.anisotropy = 8;
    metalNornal.repeat.set(8, 8);

    const truckMaterial = useMemo(
        () => new THREE.MeshStandardMaterial({
            color: truckColor,
            normalMap: metalNornal,
