        ...
        <div className='skater group relative flex flex-col items-center gap-4'>
            <div className="stack-layout overflow-hidden">
                ...
                <PrismicNextImage
                    ...
                    width={500}
                    alt=''
                    className='relative transform transition-transform duration-1000 ease-in-out group-hover:scale-110'
                />
                <div className="relative h-48 w-full place-self-end bg-linear-to-t from-black via-transparent to-transparent"></div>
                <h3 className='relative grid place-self-end justify-self-start p-2 font-sans text-brand-gray sm:text-2xl md:text-3xl'>
